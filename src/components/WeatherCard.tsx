...
export const WeatherCard = () => {
  ...
  return (
    <Card className="w-full max-w-sm mx-auto bg-white shadow-xl rounded-2xl p-6">
      ...
      <div className="text-center text-4xl font-semibold">{weatherData.temperature}°C</div>
      <p className="text-center text-gray-500 capitalize mb-4">{weatherData.description}</p>
